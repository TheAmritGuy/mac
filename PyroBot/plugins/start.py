...
async def startcmd(client:Client, message:Message):
    ...
    await message.reply_text(f'**Hello** {user_mention}, \n\n**Type /cmds to know all my commands!**', 
                  reply_markup=InlineKeyboardMarkup([
                               [InlineKeyboardButton("💠 Owner", url="t.me/Rchie1343185")],
                               [InlineKeyboardButton("💠 Helper", url="t.me/CardingNinjaa")],
                               [InlineKeyboardButton("💰 Buy Authorization", url="t.me/Rchie1343185")]]), quote=True)
